...
#		$this->assertFalse($user->has_cap('level_2'));
	...
	function test_upgrade() {
		...
		$this->assertTrue($user->exists(), "Problem getting user $id[0]");
		...
		$this->assertTrue($user_0->exists(), "Problem getting user $id[0]");
		...
		$this->assertTrue($user_1->exists(), "Problem getting user $id[1]");
		...
		$this->assertTrue($user_2->exists(), "Problem getting user $id[2]");
		...
		$this->assertTrue($user_3->exists(), "Problem getting user $id[3]");
		...
		$this->assertTrue($user_4->exists(), "Problem getting user $id[4]");
